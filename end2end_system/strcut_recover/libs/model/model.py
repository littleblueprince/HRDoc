...
class Model(nn.Module):
    ...
    def forward(self, encoder_input, encoder_input_mask, image_size, transcripts, encoder_input_bboxes, extractor,
                tokenizer, bert, ly=None, ly_mask=None, re=None, re_mask=None, pa=None, pa_mask=None):

        feats, feats_mask = self.encoder(encoder_input, encoder_input_mask, image_size, transcripts,
